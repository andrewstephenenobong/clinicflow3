...
// eslint-disable-next-line react-refresh/only-export-components -- hook is tightly coupled to AuthProvider's context; pre-existing pattern, not part of this pass's scope.
